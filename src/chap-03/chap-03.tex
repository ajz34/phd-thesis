...
\begin{equation}
    ...
    \rho_g = D_{\mu \nu} \phi_{g \mu} \phi_{g \nu}
\end{equation}
该式等式左右都包含代表空间位置的指标 $g$；该指标在等式右边被数乘，而没有最终被求和。由于 $g$ 指标并非在对偶空间中，因此若不将 $g$ 看作指标，那么在通常的 Einstein 求和下应写为
\begin{equation*}
