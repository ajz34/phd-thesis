...
本工作所涉及的记号、重要公式与约定俗成，在 \alertref{sec.3.notations} 节中定义。本论文正文将基于这些定义展开。
