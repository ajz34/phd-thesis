...
\widetabular{
  \begin{tabular}{l:d{1.3}d{1.3}:d{2.2}d{2.2}d{2.2}d{2.2}d{2.2}:d{2.2}}
  \toprule
...
\widetabular{
  \begin{tabular}{l:d{2.2}d{2.2}d{2.2}d{2.2}:d{2.2}d{2.2}d{2.2}}
  \toprule
...
\widetabular{
  ...
  \toprule
  \multicolumn{2}{l:}{MR-MGM-BE4} & \multicolumn{3}{c:}{xDH@B3LYP} & \multicolumn{3}{c}{XYG6+1\tnote{a}} \\
